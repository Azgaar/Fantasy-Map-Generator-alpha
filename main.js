...
"use strict";
const version = "0.70a"; // generator version
...
// append landback element
landmass.append("rect").attr("x", 0).attr("y", 0).attr("width", "100%").attr("height", "100%");
// append ocean pattern
oceanPattern.append("rect").attr("fill", "url(#oceanic)").attr("stroke", "none").attr("x", "-50%").attr("y", "-50%").attr("width", "200%").attr("height", "200%");
oceanLayers.append("rect").attr("id", "oceanBase").attr("x", "-50%").attr("y", "-50%").attr("width", "200%").attr("height", "200%");
...
function showWelcomeMessage() {
  ...
  if (localStorage.getItem("version") != version) {
    ...
    alertMessage.innerHTML = `The Fantasy Map Generator is updated up to version <b>${version}</b>.
      ...
      Use <a href='https://azgaar.github.io/Fantasy-Map-Generator' target='_blank'>this link</a> to access a stable version.
      ...
      <ul><a href=${link} target='_blank'>Main changes:</a>
        ...
        <li>Reworked hotkeys</li>
      </ul>

      <p>Join our <a href='https://www.reddit.com/r/FantasyMapGenerator' target='_blank'>Reddit community</a>
      to share created maps, discuss the Generator, report bugs, ask questions and propose new features.
      Also you can support the project on <a href='https://www.patreon.com/azgaar' target='_blank'>Patreon</a></i></p>`;
